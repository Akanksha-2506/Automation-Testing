...
public class LambdaIPhoneTest {
    ...
    public void setUp() throws Exception {
        ...
        ltOptions.put("name", "iPhone Test");
    ...
    @Test
    public void iPhoneLambdaTest() throws Exception {
        ...
        System.out.println("iPhone Price on LambdaTest Cloud: " + price);
        amazonPage.addToCart();
        System.out.println("iPhone added to cart on LambdaTest Cloud");
    }
